 ...
 */
@Singleton
public class TokensRepository implements TasksDataSource {
     ...
     * required to create an instance of the TokensRepository. Because {@link TasksDataSource} is an
     ...
     */
    @Inject
    TokensRepository(@Remote TasksDataSource tasksRemoteDataSource,
